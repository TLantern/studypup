...
const styles = StyleSheet.create({
  ...
  modalTitle: { fontFamily: SF_PRO, fontSize: 20, marginBottom: 20, textAlign: 'center' },
  pickerRow: { marginBottom: 16 },
  pickerLabel: { fontFamily: SF_PRO, fontSize: 14, color: '#666', marginBottom: 8 },
  ...
  pickerValue: { fontFamily: SF_PRO, fontSize: 16 },
  ...
  modalCancelText: { fontFamily: SF_PRO, fontSize: 16, color: '#333' },
  modalDoneBtn: { flex: 1, padding: 16, alignItems: 'center', borderRadius: 12, backgroundColor: '#FD8A8A' },
  modalDoneText: { fontFamily: SF_PRO, fontSize: 16, color: '#fff' },
});
