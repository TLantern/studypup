...
export default function ViralProfessionalHomeScreen() {
    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <View style={styles.pageTitleRow}>
        <Image
          ...
          style={styles.notarioBannerIcon}
          contentFit="contain"
        />
        <Text style={styles.pageTitle}>Notario</Text>
      </View>
      ...
      {showRecord && (
        <Animated.View style={[styles.recordScreen, { paddingTop: insets.top, paddingBottom: insets.bottom + scaleSize(20) }, recordAnimStyle]}>
          {/* Notario icon top-left */}
          <Image
            source={require('../assets/images/notariomainicon.png')}
            style={styles.recordScreenIcon}
            contentFit="contain"
          />
