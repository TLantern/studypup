...
export default function ProfessionalNoteDetailScreen() {
  ...
  const title = params.title ?? 'Welcome to the App!';
  const subtitle = params.subtitle ?? 'Discover all features today';
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <View style={styles.headerRow}>
        ...
        >
          <Ionicons name="ellipsis-horizontal" size={20} color={DEEP_BLACK} />
        </Pressable>
      </View>
      ...
      >
        ...
        <View style={styles.audioCard}>
          <Pressable style={styles.playBtn} onPress={() => hapticSelect()}>
          ...
          <Text style={styles.duration}>4:46</Text>
        </View>
      ...
      <View style={[styles.chatBar, { paddingBottom: insets.bottom + scaleSize(10) }]}>
        <View style={styles.chatInputWrap}>
          ...
          />
          <Pressable hitSlop={10} onPress={() => hapticSelect()}>
            <Ionicons name="mic" size={20} color={DEEP_BLACK} />
          </Pressable>
        </View>
      </View>
    </View>
